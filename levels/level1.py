def level1():
    ...
    print(f"\nOnce upon a time, there was a {adjective1} boy named {noun1}.")
    print("Although he came from a small town, he dreamed of achieving great things in life.")
    ...
    print("Whenever he faced difficulties, he treated them as opportunities to learn instead of giving up.")
    print("His teachers, friends, and family were amazed by his dedication and strong mindset.")
    ...
    print("His story reminds us that success does not come from luck but from believing in yourself, "
          "working hard, and never giving up on your dreams.")
